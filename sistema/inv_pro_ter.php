...
<body>
	...
	<div class="title_page">
		...
		<table border="0" class="table" id="example" aria-describedby="tabla">
				...
				$query = mysqli_query($conexion, "SELECT cortes, SUM(peso_restante) AS peso_restante, fecha_ingre, cod_pro 
				FROM prod_terminado 
				WHERE (peso_restante LIKE '%$busqueda%'
				...
				?>
						<tr>
							...
							<td><?= $data["cortes"]; ?></td>
							<td style="text-align: end;"><?= round($data["peso_restante"],1); ?></td>
