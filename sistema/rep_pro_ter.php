...
$reporte = "Reporte de Producto Terminado";
$namepdf = "Reporte_Pro_Ter - " . $hoy;
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
	...
	<script>
		function verify2() {
			var select2 = document.getElementById("tip_ma_m").value;
			if (select2 == 99) {
	...
	<section id="container">
		...
		<div class="title_page">
			...
			<div class="datos_desposte">
				<form id="form_rep_prot" name="form_reporte" method="post" style="padding: 0px; border: 0px; background: #00000000;">
					<div class="tipo_reporte col3 full-width">
						...
						<p id="cars" style="display: block">
							...
							<select name="tip_ma_m" onchange="verify2()" id="tip_ma_m" required>
