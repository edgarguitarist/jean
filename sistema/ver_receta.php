...
echo "<script>document.getElementById('condimento').value ='".$id_canta.'PR-'.$condimento."'</script>";
echo "<script>document.getElementById('condiment').innerHTML ='".$id_canta.'PR-'.$condimento."'</script>";
if ($contador == $filas) {
